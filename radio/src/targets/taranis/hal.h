...
// External Module
  ...
  #define EXTMODULE_TIMER_OUTPUT_ENABLE         TIM_OutputState_Enable
  #define EXTMODULE_TIMER_OUTPUT_POLARITY       TIM_OCPolarity_Low
  ...
  #define EXTMODULE_TIMER_DMA_FLAG_TC         DMA_IT_TCIF1
  #define EXTMODULE_TIMER_CHANNEL               TIM_Channel_1
  #define EXTMODULE_TIMER_OUTPUT_ENABLE         TIM_OutputNState_Enable
  #define EXTMODULE_TIMER_OUTPUT_POLARITY       TIM_OCNPolarity_Low
  #define EXTMODULE_TIMER_FREQ          (PERI2_FREQUENCY * TIMER_MULT_APB2)
#elif defined(RADIO_X9DP2019)
  #define EXTMODULE_RCC_AHB1Periph      (RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_DMA2)
  #define EXTMODULE_RCC_APB2Periph      (RCC_APB2Periph_TIM8 | RCC_APB2Periph_USART6)
  ...
  #define EXTMODULE_TIMER_DMA_STREAM_IRQHandler DMA2_Stream1_IRQHandler
  #define EXTMODULE_TIMER_DMA_FLAG_TC           DMA_IT_TCIF1
  #define EXTMODULE_TIMER_CHANNEL               TIM_Channel_2
  #define EXTMODULE_TIMER_OUTPUT_ENABLE         TIM_OutputState_Enable
  #define EXTMODULE_TIMER_OUTPUT_POLARITY       TIM_OCNPolarity_Low
  #define EXTMODULE_TIMER_FREQ                  (PERI2_FREQUENCY * TIMER_MULT_APB2)
#else
